...
// 裸 IP + HTTP 下没有 secure context，crypto.subtle 不可用，登录挑战响应必须自带实现。
// 输出与 hashlib.sha256 一致（hex 小写）；utf8 输入先做 UTF-8 编码。
(function (global) {
  "use strict";
  var K = [
  ...
  global.sha256hex = function (message) {
    var bytes = utf8Bytes(String(message));
    var bitLen = bytes.length * 8;
    bytes.push(0x80);
    while (bytes.length % 64 !== 56) bytes.push(0);
    // 64 位大端长度：输入远小于 512MB，高 32 位恒 0
    bytes.push(0, 0, 0, 0,
